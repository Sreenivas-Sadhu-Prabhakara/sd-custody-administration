package com.bank.bian.custodyadministration.model;
...
/**
 * The BIAN control record for this service domain: "Custody Holding Administrative Plan".
 *
 ...
 * to its asset type (Custody Holding). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Custody Holding Administrative Plan";
